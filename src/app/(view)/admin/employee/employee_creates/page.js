...
const EmployeeCreate = () => {
    ...
    const handleChanges = (value) => {
        if (value) {
            ...
            setSelectedDate(mysqlFormattedDate);
            setFieldes((prevAssetInfo) => ({
                ...prevAssetInfo,
                dob: mysqlFormattedDate
            }));
        }
    };
    const [formattedDisplayDate, setFormattedDisplayDate] = useState('');
    const handleChangess = (value) => {
        if (value) {
            // Format the date into MySQL format
            const mysqlFormattedDate = formatToMySQL(value);
            setFormattedDisplayDate(mysqlFormattedDate);
            setFieldes((prevAssetInfo) => ({
                ...prevAssetInfo,
                join_date: mysqlFormattedDate
            }));
        }
    };
...
const employee_create = (event) => {
    ...
    const join_date = formattedDisplayDate;
