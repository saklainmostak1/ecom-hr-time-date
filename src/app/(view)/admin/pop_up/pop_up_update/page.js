...
const PopUpUpdate = ({ id }) => {
    ...
    const handleChange = (value) => {
        if (value) {
            ...
            setFormData(prevData => ({
                ...prevData,
                pop_up_start_date: mysqlFormattedDate // Update the dob field in the state
            }));
        }
        else {
    ...
    const handleChanges = (value) => {
        if (value) {
            ...
            setFormData(prevData => ({
                ...prevData,
                pop_up_end_date: mysqlFormattedDate // Update the dob field in the state
            }));
        }
        else {
