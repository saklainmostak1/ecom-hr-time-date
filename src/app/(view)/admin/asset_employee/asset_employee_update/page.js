...
const AssetEmployeeUpdate = ({ id }) => {
    ...
    const getCurrentDate = () => {
        const date = new Date(assetInfo.handover_date);
        // Check if the date is valid
        return date;
    };

    const getCurrentDates = () => {
        const date = new Date(assetInfo.return_date);
        // Check if the date is valid
        return date;
    };
    ...
    const handleChange = (value) => {
        if (value) {
            ...
            setAssetInfo(prevData => ({
                ...prevData,
                handover_date: mysqlFormattedDate // Update the dob field in the state
            }));
        }
        else {
    ...
    const handleChanges = (value) => {
        if (value) {
            ...
            setMysqlFormattedDates(formatToMySQL(value));
            const mysqlFormattedDate = formatToMySQL(value);
            setAssetInfo(prevData => ({
                ...prevData,
                return_date: mysqlFormattedDate // Update the dob field in the state
            }));
        }
        else {
